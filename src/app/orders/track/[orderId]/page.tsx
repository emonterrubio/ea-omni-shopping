    ...
    return (
      <PageLayout>
        <div className="max-w-7xl mx-auto flex flex-col items-center justify-center px-4 py-20">
          ...
          <h1 className="text-xl font-semibold mb-2">Loading Order Tracking...</h1>
          <p className="text-gray-600">Please wait while we fetch your order tracking information.</p>
        </div>
      </PageLayout>
    );
  }
