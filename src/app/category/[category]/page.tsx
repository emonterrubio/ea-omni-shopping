...
export default function CategoryCatalogPage() {
  ...
  if (selectedCategory !== "all") {
    filteredProducts = filteredProducts.filter((product) => {
      ...
      } else if (targetCategory === 'mice & keyboard') {
        ...
        <div className="flex-1 mt-4 sm:mt-0 lg:pl-3 sm:px-4 lg:px-0">
          ...
          {filteredProducts.length === 0 ? (
            ...
            <div className="space-y-8">
              ...
              {/* Keyboards Section */}
              {keyboardsSubsection.length > 0 && (
                <div>
                  <h2 className="text-2xl font-semibold text-gray-900 mb-2 pb-2">
                    Keyboards ({keyboardsSubsection.length})
                  </h2>
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-3">
                    {keyboardsSubsection.map((product, idx) => {
                      const mappedProduct = {
                        brand: product.manufacturer,
                        model: product.model,
                        category: product.category,
              ...
              {/* Combos Section */}
              {combosSubsection.length > 0 && (
                <div>
                  <h2 className="text-2xl font-semibold text-gray-900 mb-2 pb-2">
                    Mouse & Keyboard Combos ({combosSubsection.length})
                  </h2>
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-3">
                    {combosSubsection.map((product, idx) => {
                      const mappedProduct = {
                        brand: product.manufacturer,
                        model: product.model,
                        category: product.category,
